DROP DATABASE `jquery_server`;
CREATE DATABASE `jquery_server` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `jquery_server`;
...
(232, 'user', 'mail@mail.de', 'user,', '', '', '', '', '', '', '', 'be9c0a3d41156913d36cf9715ccf63ae', '', '', 'firstname', 'lastname', '', 'ManagementUser.php', ''),
(231, 'username', 'mail@mail.de', 'username,', '5f4dcc3b5aa765d61d8327deb882cf99', '5217840915ed98901b610f61132a6c56', '::1', '', '', '1379513451', '1381313451', '', '', '', '', '', '', 'ManagementUser.php', '');
