 ...
 * DisplayServerStatusMessage: The simplest way to convert any variable to a string is to add an empty string to that variable (i.e. concatenate it with an empty string ''), for example:
